                ...
                if ($_POST['CSRF_Token'] == $_COOKIE['CSRF_token']){
					...
					<ul class='list-group'>
					  <li class='list-group-item  list-group-item-primary'>Your name is ".$name."</li>
					   <li class='list-group-item  list-group-item-success'>Your IT Number is ".$itnumber."</li>
					    <li class='list-group-item  list-group-item-warning'>Your Faculty is ".$faculty."</li>
					</ul>";
                }
                else{
