...
<html>
    ...
    <body style="background-image: url('images/loginPage.jpg'); color: white; background-size: cover; ">
        ...
        <div class="col-md-6 col-offset-3" align="center">
            ...
            <form action="login.php" method="POST" >
				...
				<div class="form-group">
					<input id="phone" type="passowrd" id="password" name="password" placeholder="Password" class="form-control" required>
